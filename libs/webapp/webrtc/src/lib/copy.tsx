...
export function Webrtc(props: WebrtcProps) {
  ...
  const [currentVideo, setCurrentVideo] = useState<RemoteStream | null>(null);
  ...
  useEffect(() => {
    const signal = new IonSFUJSONRPCSignal('ws://localhost:8000/ws');
